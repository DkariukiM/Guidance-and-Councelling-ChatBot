...
<div class="container" style="width: 100%;height: 100vh;background: linear-gradient(rgba(0,0,0,.6), rgba(0,0,0,.8)),url(assets/img/login.png) center no-repeat;background-size: cover;">
    <div class="Reset">
        <div class="form-box">
            <!------NEW PASSWORD FORM------>
            <form action="new_password.php" id="login" method="post" class="input-group">
                <?php include('includes/messages.php'); ?>
                <p>New Password</p>
                <input type="password" name="new_pass" class="input-field" placeholder="New Password" required>
                <input type="password" name="new_pass_c" class="input-field" placeholder="Confirm New Password" required>
                <button type="submit" name="new_password" class="submit-btn" style="margin-top: 20px;"> SUBMIT </button><br />
            </form>
        </div>
    </div>
</div>
