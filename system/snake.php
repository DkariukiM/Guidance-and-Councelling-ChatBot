...
<html>
    ...
    if(w==100){document.getElementById("load").style.display="none";}
            ...
            <h4>Created by: David Kariuki </h4>
        </div>
        <header>
            <div id="hl"><a href="welcome.php" style="text-decoration: none; font-weight: 500; color: #242F3F" class="back"> < Home</a> &nbsp; Your Score:</div>
            <div id="hr">0</div>
        </header>
        <div id="DIV">
        </div>
        ...
        function moved(){
            ...
            intv1=setInterval(function(){
                ...
                if(ttt>899){
                    ttt=ttt-900;}
                if(bd.indexOf(ttt)>0){
                    document.write("<h1 style='text-align:center; color:#fff; background:#1b4d4e; width:60%; margin:40px 20%; border-radius:30%; padding:16px 0px;'>"+"Game Over"+"</h1>"+"<h3 style='font-size:25px; color:#a1dcfd; text-align:center; background:#ff0b47; width:70%; margin:50px 15%; border-top-left-radius:30px; border-bottom-right-radius:30px; padding:20px 0px;'>"+"Your Score: "+score+"</h3>"+"<h1 style='text-align:center; color:#fff; background:#1b4d4e; width:60%; text-decoration: none; margin:40px 20%; border-radius:30%; padding:16px 0px;'>"+"<a href='snake.php'> Retry </a>"+"</h1>"+"<h1 style='text-align:center; text-decoration:none; color:#fff; background:#1b4d4e; width:60%; margin:40px 20%; border-radius:30%; padding:16px 0px;'>"+"<a href='welcome.php'>Home</a>"+"</h1>");
                    clearInterval(intv1);}
                else{
                    bd.push(ttt);
                    if(ttt==pnt){
