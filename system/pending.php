    ...
    <div class="Reset">
        <div class="form-box">
            ...
            <form action="enter_email.php" id="login" method="post" class="input-group">
                ...
                <p style="margin-top: 30px;">Please login into your email account and click on the link we sent to reset your password</p>
                <button type="submit" class="submit-btn" style="margin-top: 40px;"><a href="login.php" style="text-decoration: none; color: #1b1e21;"> Home </a></button><br />
